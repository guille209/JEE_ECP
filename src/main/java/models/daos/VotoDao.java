...
public interface VotoDao extends GenericDao<Voto, Integer> {
	...
	/**
	 * Devuelve una lista con 3 posiciones, una por cada nivel de estudios,
	 * en cada posicion un double con la valoracion media correspondiente.
	 * Si no hay en BD ningun voto de un nivel de estudios en su posicion 
	 * se devuelve un -1
	 * @return
	 */
